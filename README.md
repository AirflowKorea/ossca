...
xychart-beta
    ...
    y-axis "PR 수" 0 --> 67
    line [0, 0, 0, 0, 0, 0, 0, 0, 2, 52, 66]
    line [0, 0, 0, 0, 0, 0, 0, 0, 1, 39, 46]
```

> 🔵 **작성 PR** · 🟠 **리뷰 PR** (매주 월요일 시점의 누계, 마지막 점은 오늘 시점)

_마지막 업데이트: 2026-05-10 21:52 UTC_
