...
xychart-beta
    ...
    y-axis "PR 수" 0 --> 116
    line [0, 0, 0, 0, 0, 0, 0, 0, 2, 52, 66, 80, 89, 98, 98, 103, 104, 106, 108, 111, 112, 112, 114, 114, 115, 115, 115, 115, 115, 115, 115]
    line [0, 0, 0, 0, 0, 0, 0, 0, 1, 41, 49, 58, 67, 70, 71, 75, 75, 77, 77, 77, 77, 77, 77, 77, 77, 77, 77, 77, 77, 77, 77]
```

> 🔵 **작성 PR** · 🟠 **리뷰 PR** (매주 월요일 시점의 누계, 마지막 점은 오늘 시점)

_마지막 업데이트: 2026-09-24 23:47 UTC_
